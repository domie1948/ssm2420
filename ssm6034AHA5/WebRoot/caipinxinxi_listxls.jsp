...
<jsp:useBean id="caipinxinxihsgb" scope="page" class="com.bean.CaipinxinxiBean" /> 

<%
response.setContentType("application/vnd.ms-excel");
response.addHeader("Content-Disposition", "attachment;filename=caipinxinxi.xls");
%>
<html>
  <head>
    <title>菜品信息</title>
  ...
  <body >
 <%
			String sql="select * from caipinxinxi  order by id desc";
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
   ...
   <%		
				List pagelist3=caipinxinxihsgb.getAllCaipinxinxi(10);

...
public class db {
	...
	// private String sConnStr = "jdbc:microsoft:sqlserver://localhost:1433;databasename=ssmfdcyglxthsg6034AHA5"; 
	 
	 private String dbDriver="com.mysql.jdbc.Driver";
	 private String sConnStr = "jdbc:mysql://localhost:3306/ssmfdcyglxthsg6034AHA5?useUnicode=true&amp;amp;amp;amp;amp;characterEncoding=gb2312"; 
	
	 // private String dbDriver="net.sourceforge.jtds.jdbc.Driver";
	// private String sConnStr = "jdbc:jtds:sqlserver://127.0.0.1:1433;databaseName=ssmfdcyglxthsg6034AHA5"; 
	 ...
	 private List list;
	  ...
	  public List getShouyebht(){
		...
		public String getddnr(String nuser){
			...
			String sql = "select caipinmingcheng,goumaishuliang from goumaijilu where goumairen = '"+nuser+"' and issh='否' ";
			System.out.print(sql);
			...
			try{
				...
				while(rs.next()){
						...
						ddnr=ddnr+"菜品名称："+rs.getString(1)+"，购买数量："+rs.getString(2)+"；\r\n";
				}
				return ddnr;
			}catch(Exception e){
				e.printStackTrace();
